...
public class QPostTag extends EntityPathBase<PostTag> {
    ...
    private static final long serialVersionUID = 2028108789L;
    ...
    public final com.example.techlog.post.domain.QPost post;
    ...
    public QPostTag(Class<? extends PostTag> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.example.techlog.post.domain.QPost(forProperty("post"), inits.get("post")) : null;
